  ...
  head: () => ({
    meta: [
      ...
      { title: "Mizan — Private Personal Finance Tracking" },
      {
        name: "description",
        content:
          "Track income, expenses, transfers, credit cards and savings goals in one private dashboard.",
      },
      ...
      { property: "og:title", content: "Mizan — Private Personal Finance Tracking" },
      {
        ...
        content: "Manual, private money tracking with budgets, goals and analytics.",
      },
